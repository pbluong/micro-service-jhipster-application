...
import com.selfstudy.jhipster.micro.config.KafkaProperties;
...
class MicroServiceJHipsterApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        MicroServiceJHipsterApplicationKafkaResource kafkaResource = new MicroServiceJHipsterApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/micro-service-j-hipster-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/micro-service-j-hipster-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
