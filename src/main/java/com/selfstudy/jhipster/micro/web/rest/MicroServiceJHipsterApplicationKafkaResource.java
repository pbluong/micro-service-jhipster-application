...
@RestController
@RequestMapping("/api/micro-service-j-hipster-application-kafka")
public class MicroServiceJHipsterApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroServiceJHipsterApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroServiceJHipsterApplicationKafkaResource(KafkaProperties kafkaProperties) {
